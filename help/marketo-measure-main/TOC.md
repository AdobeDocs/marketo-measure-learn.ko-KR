...
+ [Marketo Measure 개요](/help/marketo-measure-main/marketo-measure-overview.md)
...
+ 온보딩 {#onboarding}
   + 모범 사례 {#best-practices}
      ...
      + [채널 및 통합 설정 검토(Pt.2)](/help/marketo-measure-main/onboarding/fundamentals/channel-integration-settings.md)
      + [CRM 설정(Pt.3)](/help/marketo-measure-main/onboarding/fundamentals/crm-settings.md)
      + [Lead, Contact 및 Opportunity 설정](/help/marketo-measure-main/onboarding/fundamentals/leads-contacts-opps-settings.md)
      + [온라인 채널 설정](/help/marketo-measure-main/onboarding/fundamentals/online-channel-setup.md)
      + [광고 연결 개요](/help/marketo-measure-main/onboarding/fundamentals/ads-connection-overview.md)
      + [SFDC 설치 개요](/help/marketo-measure-main/onboarding/fundamentals/sfdc-installation-overview.md)
      + [오프라인 채널 설정](/help/marketo-measure-main/onboarding/fundamentals/offline-channel-setup.md)
      + [Marketo Engage과의 연결](/help/marketo-measure-main/onboarding/fundamentals/connection-with-marketo-engage.md)
   ...
   + [!DNL Marketo Measure] 및 Salesforce{#marketo-measure-salesforce}
      + [ID별 리드 보고서](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/leads-by-id-report.md)
      + [채널 및 하위 채널 만들기](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/creating-channels-subchannels.md)
      + [CSV 파일로 채널 규칙 설정](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/channel-rules-csv.md)
      + [Campaign 개체 필드](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/campaign-object-fields.md)
      + [오프라인 채널 매핑](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/mapping-offline-channels.md)
      + [오프라인 캠페인 동기화](/help/marketo-measure-main/onboarding/marketo-measure-salesforce/syncing-offline-campaigns.md)
   + 기본 사항{#fundamentals}
...
+ [!DNL Marketo Measure] 검색 {#marketo-measure-discover}
   ...
   + [수행 중인 채널 확인(Pt.1)](/help/marketo-measure-main/marketo-measure-discover/top-of-funnel-reporting.md)
   + [수행 중인 채널 확인(Pt.2)](/help/marketo-measure-main/marketo-measure-discover/determine-which-channel-is-performing.md)
   + [funnel 보고 살펴보기(Pt.3)](/help/marketo-measure-main/marketo-measure-discover/build-a-full-funnel-report-pt3.md)
+ 정의 {#definitions}
   + 접점{#touchpoints}
      + [터치포인트란 무엇입니까?](/help/marketo-measure-main/definitions/touchpoints/what-is-a-touchpoint.md)
      + [이정표 접점](/help/marketo-measure-main/definitions/touchpoints/milestone-touchpoints.md)
      + [접점 구성 요소](/help/marketo-measure-main/definitions/touchpoints/touchpoint-components.md)
      + [온라인 및 오프라인 터치포인트](/help/marketo-measure-main/definitions/touchpoints/online-offline-touchpoints.md)
   + 속성 {#attribution}
      + [속성이란 무엇입니까?](/help/marketo-measure-main/definitions/attribution/what-is-attribution.md)
      + [속성 모델](/help/marketo-measure-main/definitions/attribution/attribution-models.md)
      + [첫 번째 터치 모델](/help/marketo-measure-main/definitions/attribution/first-touch-model.md)
      + [잠재 고객 생성 모델](/help/marketo-measure-main/definitions/attribution/lead-creation-model.md)
      + [U자형 모형](/help/marketo-measure-main/definitions/attribution/u-shaped-model.md)
   ...
   + CRM 개체 {#crm-objects}
      ...
      + [영업 기회 개체](/help/marketo-measure-main/definitions/crm-objects/opportunity-object.md)
      + [BT 개체](/help/marketo-measure-main/definitions/crm-objects/bt-object.md)
   ...
   + UTM 매개 변수 {#utm-parameters}
      ...
      + [UTM 태깅](/help/marketo-measure-main/definitions/utm-parameters/utm-tagging.md)
   + 계정 기반 마케팅 {#account-based-marketing}
      + [[!UICONTROL Account Based Marketing] 개요](/help/marketo-measure-main/definitions/account-based-marketing/abm-overview.md)
      ...
      + [[!UICONTROL Accounts with Leads and Contacts] 보고서](/help/marketo-measure-main/definitions/account-based-marketing/accounts-with-leads-and-contacts.md)
      + [[!UICONTROL Touchpoints per Account] 보고서](/help/marketo-measure-main/definitions/account-based-marketing/touchpoints-per-account-report.md)
   + 부메랑 단계 {#boomerang-stage}
      + [부메랑 단계 소개](/help/marketo-measure-main/definitions/boomerang-stage/introduction-to-boomerang-stages.md)
      + [부메랑 단계 설정](/help/marketo-measure-main/definitions/boomerang-stage/setting-up-boomerang-stages.md)
+ Marketo Measure Ultimate {#marketo-measure-ultimate}
   + [Marketo Measure Ultimate 개요](/help/marketo-measure-main/marketo-measure-ultimate/overview.md)
   + [Attribution AI 개요](/help/marketo-measure-main/marketo-measure-ultimate/attribution-ai-overview.md)
+ 전도자 회담 {#evangelist}
   + [마케팅 속성 및 지표](/help/marketo-measure-main/evangelist-talks/attribution-and-metrics.md)
